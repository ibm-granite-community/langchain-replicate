...
class TestChat:
    ...
    def test_invoke_multiple_stop_sequences(self) -> None:
        ...
        assert_that(output.text).does_not_contain("5").does_not_contain("8").does_not_contain("10")
    ...
    def test_stream_multiple_stop_sequences(self) -> None:
        ...
        if combined is not None:
            ...
            # Output should be truncated at the earliest stop sequence
            assert_that(combined.text).does_not_contain("5").does_not_contain("8").does_not_contain("10")
